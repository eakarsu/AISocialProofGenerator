...
// Feature: Authenticity scoring to detect AI-generated vs real testimonials and flag liability
...
export default function CfAuthenticityScoringToDetectAiGeneratedVs() {
  ...
  const submit = async (e) => {
    ...
    try {
      const res = await fetch(`${API_BASE}/api/cf-authenticity-scoring-to-detect-ai-generated-vs-real-testimonials/run`, {
        method: 'POST', headers: getHeaders(),
        body: JSON.stringify({ prompt: input, feature: 'cf-authenticity-scoring-to-detect-ai-generated-vs-real-testimonials', project: 'AISocialProofGenerator' })
      })
  ...
  const loadHistory = async () => {
    try {
      const res = await fetch(`${API_BASE}/api/cf-authenticity-scoring-to-detect-ai-generated-vs-real-testimonials/history`, { headers: getHeaders() })
      const data = await res.json()
  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      <div className="mb-4">
        <h1 className="text-2xl font-bold text-slate-800">Authenticity scoring to detect AI-generated vs real testimonials and flag liability</h1>
