...
function Sidebar() {
  ...
  const navItems = [
    ...
    },
    {
      ...
      label: 'Testimonial Likelihood',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.75} d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.196-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.783-.57-.38-1.81.588-1.81h4.915a1 1 0 00.95-.69l1.519-4.674z" />
        </svg>
      ),
    },
    {
      path: '/authenticity-scorer',
      label: 'Authenticity Scorer',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    { path: '/cf-competitive-testimonial-analysis-via-rag-over-competitor-reviews', label: 'Competitive testimonial analysis via RAG over comp...' },
    { path: '/cf-authenticity-scoring-to-detect-ai-generated-vs-real-testimonials', label: 'Authenticity scoring to detect AI-generated vs rea...' },
    { path: '/cf-one-click-marketplace-publishing-to-capterra-g2-producthunt-with', label: 'One-click marketplace publishing to Capterra, G2,...' },
    { path: '/cf-review-crawler-service-with-scheduled-polling-of-external', label: 'Review crawler service with scheduled polling of e...' },
    { path: '/gap-no-ai-driven-customer-segmentation-for-targeted-testimonial-selection', label: 'No AI-driven customer segmentation for targeted te...' },
    { path: '/gap-no-predictive-scoring-for-which-customers-are-most', label: 'No predictive scoring for which customers are most...' },
    { path: '/gap-no-automated-visual-asset-poster-social-card-generation', label: 'No automated visual asset (poster/social card) gen...' },
    { path: '/gap-no-integrations-with-trustpilot-g2-capterra-review-platforms', label: 'No integrations with Trustpilot, G2, Capterra revi...' },
    { path: '/gap-no-a-b-testing-framework-for-widget-placement', label: 'No A/B testing framework for widget placement/mess...' },
    { path: '/gap-no-scheduled-batch-review-crawling-from-external-sources', label: 'No scheduled batch review crawling from external s...' },
    { path: '/gap-no-webhooks-notifications-system-for-new-review-or', label: 'No webhooks/notifications system for new review or...' },
    { path: '/gap-limited-audit-logging-single-reference-not-a-dedicated', label: 'Limited audit logging (single reference, not a ded...' },
  ]
